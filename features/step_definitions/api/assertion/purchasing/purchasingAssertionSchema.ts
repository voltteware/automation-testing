...
export const itemsInPurchasingResponseSchema = z.object({
    ...
    s7d: z.number().nullable(),
    s30d: z.number().nullable(),
    s90d: z.number().nullable(),
    s365d: z.number().nullable(),
    sMtd: z.number().nullable(),
    sYtd: z.number().nullable(),
    s_2d: z.number().nullable(),
    s_180d: z.number().nullable(),
    s_60d: z.number().nullable(),
