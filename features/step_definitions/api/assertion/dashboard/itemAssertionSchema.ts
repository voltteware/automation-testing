...
export const itemRestockAMZInfoResponseSchema = z.object({
    ...
    forecastconstant: z.object({
        ...
        openPurchaseOrders: z.number().nullable(),
        openSalesOrders: z.number(),
        orderInterval: z.number(),
        tags: z.array(z.string().nullable()).nullable(), /* z.string().optional().array(); => (string | undefined)[]  or z.string().array().optional(); => string[] | undefined */
        type: z.string(),
...
export const itemInfoResponseSchema = z.object({
    ...
    forecastTags: z.array(z.string().nullable()).nullable(),
    tags: z.array(z.string().nullable()).nullable(),
    inbound: z.number(),
    inboundPrice: z.number(),
    inboundAvailable: z.number(),
