...
Feature: API_Dashboard GET /api/bom
    ...
    Scenario Outline: <scenario> - Verify error when user sends this API with <cookie> cookie, <companyKeyHeader> companyKey, <companyTypeHeader> companyType value in header
        ...
        Examples:
            ...
            | TC_GB002_1 | testautoforecast@gmail.com | invalid | invalid          | invalid           | 401            | Unauthorized          |
            | TC_GB002_2 | testautoforecast@gmail.com | invalid | valid            | valid             | 401            | Unauthorized          |
            | TC_GB002_3 | testautoforecast@gmail.com | valid   | invalid          | invalid           | 400            | Company not found.    |
            | TC_GB002_4 | testautoforecast@gmail.com | valid   |                  |                   | 500            | Internal Server Error |
