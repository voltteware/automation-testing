...
Feature: API_Dashboard GET /api/vendor
    ...
    # @TC_GS004
    # Scenario Outline: TC_GS001 - Verify user could set limit 100 in this API to get list 100 suppliers if any
    #     Given User sets GET api endpoint to get information of a company belongs to <email> using company key <companyKey>
    #     And User sets valid cookie of <email> and valid companyKey and valid companyType in the header
    ...
    #     # And User checks values in response of random supplier are correct
    #     Examples:
    #         | user  | email                      | password  | limitRow | sortField | direction | companyKey | expectedStatus |
    #         | admin | testautoforecast@gmail.com | Test1111! | 100      | name      | asc       | random     | 200            |
