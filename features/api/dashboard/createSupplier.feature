...
Feature: API_Dashboard POST /api/vendor
    ...
    Scenario Outline: <scenario> - Verify error when user sends this API with <cookie> cookie, <companyKeyHeader> companyKey, <companyTypeHeader> companyType value in header
        ...
        Examples:
            ...
            | TC_CV003_1 | testautoforecast@gmail.com | random     | invalid | invalid          | invalid           | New Supplier Auto | New description | newemail@gmail.com | 1   | 8        | 15            | 6            | 401            | Unauthorized          |
            | TC_CV003_2 | testautoforecast@gmail.com | random     | invalid | valid            | valid             | New Supplier Auto | New description | newemail@gmail.com | 1   | 8        | 15            | 6            | 401            | Unauthorized          |
            | TC_CV003_3 | testautoforecast@gmail.com | random     | valid   | invalid          | invalid           | New Supplier Auto | New description | newemail@gmail.com | 1   | 8        | 15            | 6            | 400            | Company not found.    |
            | TC_CV003_4 | testautoforecast@gmail.com | random     | valid   |                  |                   | New Supplier Auto | New description | newemail@gmail.com | 1   | 8        | 15            | 6            | 500            | Internal Server Error |
    ...
    Scenario Outline: <TC_ID> - Verify user <email> could call this API to create supplier with <scenario>
        ...
        Examples:
            ...
            | TC_CV006_1 | ASC company restockModel = Use Store Rule (Supplier Ships to FBA) | testautoforecast@gmail.com | New Supplier Auto | New description | newemail@gmail.com | 1      | 10       | 30            | 10           | 100              | 100                | GLOBAL       | random     | 200            |
