...
Feature: API_Dashboard POST /api/item
    ...
    Scenario Outline: TC_CI001 - Verify user <email> could call this API to create item for supplier <supplier> with input all data valid
        ...
        Examples:
            | supplier | email                      | limitRow | itemName      | description     | vendorName | vendorPrice | moq    | leadTime | orderInterval | serviceLevel | onHand | onHandMin | onHandThirdParty | onHandThirdPartyMin | lotMultipleQty | lotMultipleItemName | expectedStatus |
            | CSV      | testautoforecast@gmail.com | 50       | New Item Auto | New description | random     | random      | random | random   | random        | random       | random | random    | random           |random               | random         | random              | 200            |
    ...
    Scenario Outline: <scenario> - Verify error when user sends this API with <cookie> cookie, <companyKeyHeader> companyKey, <companyTypeHeader> companyType value in header
        ...
        Examples:
            | scenario   | email                      | limitRow | cookie  | companyKeyHeader | companyTypeHeader | itemName      | description     | vendorName | vendorPrice | moq    | leadTime | orderInterval | serviceLevel | onHand | onHandMin | onHandThirdParty | onHandThirdPartyMin | lotMultipleQty | lotMultipleItemName | expectedStatus | expectedStatusText    |
            | TC_CI003_1 | testautoforecast@gmail.com | 50       | invalid | invalid          | invalid           | New Item Auto | New description | random     | random      | random | random   | random        | random       | random | random    | random           |random               | random         | random              | 401            | Unauthorized          |
            | TC_CI003_2 | testautoforecast@gmail.com | 50       | invalid | valid            | valid             | New Item Auto | New description | random     | random      | random | random   | random        | random       | random | random    | random           |random               | random         | random              | 401            | Unauthorized          |
            | TC_CI003_3 | testautoforecast@gmail.com | 50       | valid   | invalid          | invalid           | New Item Auto | New description | random     | random      | random | random   | random        | random       | random | random    | random           |random               | random         | random              | 400            | Company not found.    |
            | TC_CI003_4 | testautoforecast@gmail.com | 50       | valid   |                  |                   | New Item Auto | New description | random     | random      | random | random   | random        | random       | random | random    | random           |random               | random         | random              | 500            | Internal Server Error |
    ...
    Scenario Outline: TC_CI004 - Verify user <userA> could not call this API to create item of company which does not belongs to her
        ...
        And The status text is "<expectedStatusText>"
        Examples:
            | userA               | userB                      | password  | limitRow | itemName      | description     | vendorName | vendorPrice | moq    | leadTime | orderInterval | serviceLevel | onHand | onHandMin | onHandThirdParty | onHandThirdPartyMin | lotMultipleQty | lotMultipleItemName | expectedStatus | expectedStatusText    |
            | may27user@gmail.com | testautoforecast@gmail.com | Test1111! | 50       | New Item Auto | New description | random     | random      | random | random   | random        | random       | random | random    | random           |random               | random         | random              | 400            | Company not found.    |
    ...
    Scenario Outline: TC_CI005 - Verify error FNSKU already exists
        ...
        And The status text is "<expectedStatusText>"
        Examples:
            | email                      | itemName      | limitRow | description     | vendorName | vendorPrice | moq    | leadTime | orderInterval | serviceLevel | onHand | onHandMin | onHandThirdParty | onHandThirdPartyMin | lotMultipleQty | lotMultipleItemName | asin   | fnsku  | skuNotes | prepNotes | supplierRebate | inboundShippingCost | reshippingCost | repackagingMaterialCost | repackingLaborCost | rank   | inventorySourcePreference | average7DayPrice | isFbm  | expectedStatus | expectedStatusText                      |
            | testautoforecast@gmail.com | New Item Auto | 50       | New description | random     | random      | random | random   | random        | random       | random | random    | random           | random              | random         | random              | random | random | random   | random    | random         | random              | random         | random                  | random             | random | FBA + FBM                 | random           | random | 400            | Item with the same FNSKU already exists |
    ...
    Scenario Outline: TC_CI006 - Verify error Item Name and Supplier Name already exists
        ...
        And The status text is "<expectedStatusText>"
        Examples:
            | email                      | itemName      | limitRow | description     | vendorName | vendorPrice | moq    | leadTime | orderInterval | serviceLevel | onHand | onHandMin | onHandThirdParty | onHandThirdPartyMin | lotMultipleQty | lotMultipleItemName | expectedStatus | expectedStatusText                                                 |
            | testautoforecast@gmail.com | New Item Auto | 50       | New description | random     | random      | random | random   | random        | random       | random | random    | random           |random               | random         | random              | 400            | Item with the same Item Name and same Supplier Name already exists |