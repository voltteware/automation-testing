...
Feature: API_Purchasing GET api/grid-view/suggested-pos
    ...
    @TC_GVSP002 @bug-permission @low-bug-skip
    Scenario Outline: <scenario> - Verify error when user sends this API with <cookie> cookie, <companyKeyHeader> companyKey, <companyTypeHeader> companyType value in header
        ...
        Examples:
            ...
            | TC_GVSP002_1 | testgridview@gmail.com | random     | invalid | invalid          | invalid           | 401            | Unauthorized          |
            | TC_GVSP002_2 | testgridview@gmail.com | random     | invalid | valid            | valid             | 401            | Unauthorized          |
            | TC_GVSP002_3 | testgridview@gmail.com | random     | valid   | invalid          | invalid           | 400            | Company not found.    |
            | TC_GVSP002_4 | testgridview@gmail.com | random     | valid   |                  |                   | 500            | Internal Server Error |
