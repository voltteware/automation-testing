...
Feature: API Purchasing Setting for Daily Sale Rate
    ...
    Scenario Outline: <TC_ID> - Verify if an item has been assigned for a Supplier (Manage Company > Suppliers) then this item in "Purchasing > Custom" will be applied to the setting the same as that supplier
        ...
        Examples:
            | TC_ID         | companyType | email                      | expectedStatusText | limitRow | value                        | expectedStatus |
            | TC_CSVRL002_1 | ASC         | testautoforecast@gmail.com | OK                 | 10       | supplierUpdatedSalesVelocity | 200            |

    # #Invalid test scenario so I will comment this => Will change another test scenario to make sense
    # @TC_CSVRL002
    ...
    #     Examples:
    #         | TC_ID         | companyType | email                      | expectedStatusText | limitRow | value                        | expectedStatus |
    #         | TC_CSVRL002_2 | ASC         | testautoforecast@gmail.com | OK                 | 10       | supplierUpdatedSalesVelocity | 200            |
