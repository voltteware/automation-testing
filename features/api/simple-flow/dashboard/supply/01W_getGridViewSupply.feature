...
Feature: API_Dashboard GET /api/grid-view/supply
    ...
    Scenario Outline: TC_GVSL001 - Verify user <email> could call this API to get grid view supply by using company key and company type
        ...
        And User sets GET api endpoint to get grid view supply
        When User sends a GET request to get grid view supply of <email> by company key and company type
        ...
        Examples:
            ...
            | admin | testgetsupply@gmail.com | Test1111# | random     | 200            |
    ...
    Scenario Outline: <scenario> - Verify error when user sends this API with <cookie> cookie, <companyKeyHeader> companyKey, <companyTypeHeader> companyType value in header
        Given User sets GET api endpoint to get grid view supply
        ...
        Examples:
            ...
            | TC_GVSL002_1 | testgetsupply@gmail.com | random     | invalid | invalid          | invalid           | 401            | Unauthorized          |
            | TC_GVSL002_2 | testgetsupply@gmail.com | random     | invalid | valid            | valid             | 401            | Unauthorized          |
            | TC_GVSL002_3 | testgetsupply@gmail.com | random     | valid   | invalid          | invalid           | 400            | Company not found.    |
            | TC_GVSL002_4 | testgetsupply@gmail.com | random     | valid   |                  |                   | 500            | Internal Server Error |
    ...
    Scenario Outline: TC_GVSL003 - Verify user <userA> could not call this API to get grid view in the supply of company which does not belongs to her
        ...
        When User sends a GET request to get grid view supply of <userB> by company key and company type
        Then The expected status code should be <expectedStatus>
        And The status text is "<expectedStatusText>"
        Examples:
