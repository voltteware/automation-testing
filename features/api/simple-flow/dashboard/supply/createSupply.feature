...
Feature: API_Dashboard POST /api/supply
    ...
    Scenario Outline: <scenario> - Verify user <email> could call this API to create supply for company has type <companyType> with input all data valid
        ...
        Examples:
            ...
            | TC_CSL001 | CSV         | testautoforecast@gmail.com | 10       | random     | random | random     | random    | random  | random  | random   | random  | random   | random  | random   | random | 200            |
            | TC_CSL002 | ASC         | testautoforecast@gmail.com | 10       | random     | random | random     | random    | random  | random  | random   | random  | random   | random  | random   | random | 200            |

    #TC_CSL003_1, TC_CSL003_2 fail due to bug api
    @TC_CSL003 @low-bug-skip
    ...
    Scenario Outline: TC_CSL005 - Verify error orderKey and rowKey already exists
        ...
        Examples:
            ...
            | testautoforecast@gmail.com | 10       | random     | random | random     | random    | random  | random  | random   | random  | random   | random  | random   | random | 400            | Record already exists. |
    ...
    Scenario Outline: TC_CSL006 - Verify error when user input invalid date in the docDate and dueDate
        ...
        Examples:
            ...
            | testautoforecast@gmail.com | 5        | random     | random | invalid | invalid | random   | random  | random   | random  | random   | random | 400            | Unable to create record. |
    ...
    Scenario Outline: TC_CSL007 - Verify error when user input is missing one required field
        ...
        Examples:
            | email                      | limitRow | supplyUuid | refNum | docDate | dueDate | itemName | itemKey | orderQty | openQty | orderKey | rowKey | expectedStatus | expectedStatusText         |
            | testautoforecast@gmail.com | 5        | random     | random | random  | random  |          |         | random   | random  | random   | random | 400            | Missing required property. |
    ...
    Scenario Outline: TC_CSL008 - Verify error when user input invalid in the vendorname and vendorkey
        ...
        Examples:
            | email                      | limitRow | supplyUuid | refNum | vendorName | vendorKey | docDate | dueDate | itemName | itemKey | orderQty | openQty | orderKey | rowKey | expectedStatus | expectedStatusText       |
            | testautoforecast@gmail.com | 5        | random     | random | invalid    | invalid   | random  | random  | random   | random  | random   | random  | random   | random | 400            | Unable to create record. |
