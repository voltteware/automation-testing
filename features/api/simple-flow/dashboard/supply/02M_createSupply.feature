...
Feature: API_Dashboard POST /api/supply
    Background: Send GET /realm request to get all company keys of current logged in user before each test
        Given user sends a POST login request to get valid cookie with role
            ...
            | admin | testcreatesupply@gmail.com | Test1111# |
    ...
    Scenario Outline: <scenario> - Verify user <email> could call this API to create supply for company has type <companyType> with input all data valid
        ...
        Examples:
            ...
            | TC_CSL001 | CSV         | testcreatesupply@gmail.com | 10       | random     | random | random     | random    | random  | random  | random   | random  | random   | random  | random   | random | 200            |
            | TC_CSL002 | ASC         | testcreatesupply@gmail.com | 10       | random     | random | random     | random    | random  | random  | random   | random  | random   | random  | random   | random | 200            |
    ...
    Scenario Outline: <scenario> - Verify error when user sends this API with <cookie> cookie, <companyKeyHeader> companyKey, <companyTypeHeader> companyType value in header
        ...
        And User sets request body with payload as supplyUuid: "<supplyUuid>" and refNum: "<refNum>" and vendorName: "" and vendorKey: "" and docDate: "<docDate>" and dueDate: "<dueDate>" and itemName: "<itemName>" and itemKey: "<itemKey>" and orderQty: "<orderQty>" and openQty: "<openQty>" and orderKey: "<orderKey>" and rowKey: "<rowKey>"
        When User sends a POST method to create supply
        Then The expected status code should be <expectedStatus>
        And The status text is "<expectedStatusText>"
        Examples:
            | scenario    | companyType | email                      | limitRow | cookie  | companyKeyHeader | companyTypeHeader | supplyUuid | refNum | docDate | dueDate | itemName | itemKey | orderQty | openQty | orderKey | rowKey | expectedStatus | expectedStatusText    |
            | TC_CSL003_1 | CSV         | testcreatesupply@gmail.com | 5        | invalid | invalid          | invalid           | random     | random | random  | random  | random   | random  | random   | random  | random   | random | 401            | Unauthorized          |
            | TC_CSL003_2 | ASC         | testcreatesupply@gmail.com | 5        | invalid | valid            | valid             | random     | random | random  | random  | random   | random  | random   | random  | random   | random | 401            | Unauthorized          |
            | TC_CSL003_3 | CSV         | testcreatesupply@gmail.com | 5        | valid   | invalid          | invalid           | random     | random | random  | random  | random   | random  | random   | random  | random   | random | 400            | Company not found.    |
            | TC_CSL003_4 | ASC         | testcreatesupply@gmail.com | 5        | valid   |                  |                   | random     | random | random  | random  | random   | random  | random   | random  | random   | random | 500            | Internal Server Error |
    ...
    Scenario Outline: TC_CSL004 - Verify user <userA> could not call this API to create supply of company which does not belongs to her
        ...
        Examples:
            ...
            | may27user@gmail.com | testcreatesupply@gmail.com | Test1111# | 5        | random     | random | random  | random  | random   | random  | random   | random  | random   | random | 400            | Company not found. |
    ...
    Scenario Outline: TC_CSL005 - Verify error orderKey and rowKey already exists
        ...
        Examples:
            ...
            | testcreatesupply@gmail.com | 10       | random     | random | random     | random    | random  | random  | random   | random  | random   | random  | random   | random | 400            | Record already exists. |
    ...
    Scenario Outline: TC_CSL006 - Verify error when user input invalid date in the docDate and dueDate
        ...
        And The status text is "<expectedStatusText>"
        Examples:
            | email                      | limitRow | supplyUuid | refNum | docDate | dueDate | itemName | itemKey | orderQty | openQty | orderKey | rowKey | expectedStatus | expectedStatusText       |
            | testcreatesupply@gmail.com | 5        | random     | random | invalid | invalid | random   | random  | random   | random  | random   | random | 400            | Unable to create record. |
    ...
    Scenario Outline: TC_CSL007 - Verify error when user input is missing one required field
        ...
        Examples:
            | email                      | limitRow | supplyUuid | refNum | docDate | dueDate | itemName | itemKey | orderQty | openQty | orderKey | rowKey | expectedStatus | expectedStatusText         |
            | testcreatesupply@gmail.com | 5        | random     | random | random  | random  |          |         | random   | random  | random   | random | 400            | Missing required property. |
    ...
    Scenario Outline: TC_CSL008 - Verify error when user input invalid in the vendorname and vendorkey
        ...
        Examples:
            | email                      | limitRow | supplyUuid | refNum | vendorName | vendorKey | docDate | dueDate | itemName | itemKey | orderQty | openQty | orderKey | rowKey | expectedStatus | expectedStatusText       |
            | testcreatesupply@gmail.com | 5        | random     | random | invalid    | invalid   | random  | random  | random   | random  | random   | random  | random   | random | 400            | Unable to create record. |
    ...
    Scenario Outline: <scenario> - Verify user could not call this API with company has type <companyType>
        ...
        Examples:
            ...
            | TC_CSL009 | QBFS        | testcreatesupply@gmail.com | 10       | random     | random | random     | random    | random  | random  | random   | random  | random   | random  | random   | random | 400            | Bad Request        |
            # | TC_CSL010 | QBO         | testcreatesupply@gmail.com | 10       | random     | random | random     | random    | random  | random  | random   | random  | random   | random  | random   | random | 400            | Bad Request        |