...
Feature: API_DashBoard DELETE/deleteGridView
    Background: Send GET request to get grid view keys of current logged in user before each test
        ...
        And User sets GET api endpoint to get information of a company belongs to testgridview@gmail.com using company key random
        And User sets valid cookie of testgridview@gmail.com and valid companyKey and valid companyType in the header
        And User sets GET api endpoint to get grid view suppliers keys
        When User sends a GET request to get grid view suppliers of testgridview@gmail.com by company key and company type
    ...
    Scenario Outline: TC_DGV001 - Verify user <email> could call this API to delete grid view of a company belongs to her
        ...
        Examples:
            ...
            | testgridview@gmail.com | 204            | No Content         | random |
    ...
    Scenario Outline: <TC_ID> - Verify error when user sends this API with <cookie> cookie and <companyKeyHeader> companyKeyHeader and <companyTypeHeader> companyTypeHeader
        ...
        Examples:
            ...
            | TC_DGV002_1 | testgridview@gmail.com | random | invalid | invalid          | invalid           | 401            | Unauthorized          |
            | TC_DGV002_2 | testgridview@gmail.com | random | invalid | valid            | valid             | 401            | Unauthorized          |
            | TC_DGV002_3 | testgridview@gmail.com | random | valid   | invalid          | invalid           | 400            | Company not found.    |
            | TC_DGV002_4 | testgridview@gmail.com | random | valid   |                  |                   | 500            | Internal Server Error |
    ...
    Scenario Outline: TC_DGV004 - Verify user <email> can't call this API to delete grid-view not exists in of a company
        ...
        Examples:
            ...
            | testgridview@gmail.com | random | 404            | Not Found          |