...
Feature: API_Dashboard GET /api/grid-view/supplier
    ...
    Scenario Outline: TC_GVV001 - Verify user <email> could call this API to get grid view supplier by using company key and company type
        ...
        Examples:
            ...
            | admin | testcreatesupplier@gmail.com | Test1111# | random     | 200            |
    ...
    Scenario Outline: <scenario> - Verify error when user sends this API with <cookie> cookie, <companyKeyHeader> companyKey, <companyTypeHeader> companyType value in header
        ...
        Examples:
            ...
            | TC_GVV002_1 | testcreatesupplier@gmail.com | random     | invalid | invalid          | invalid           | 401            | Unauthorized          |
            | TC_GVV002_2 | testcreatesupplier@gmail.com | random     | invalid | valid            | valid             | 401            | Unauthorized          |
            | TC_GVV002_3 | testcreatesupplier@gmail.com | random     | valid   | invalid          | invalid           | 400            | Company not found.    |
            | TC_GVV002_4 | testcreatesupplier@gmail.com | random     | valid   |                  |                   | 500            | Internal Server Error |
    ...
    Scenario Outline: TC_GVV003 - Verify user <userA> could not call this API to get grid view in the supplier of company which does not belongs to her
        ...
        Examples:
            ...
            | may27user@gmail.com | testcreatesupplier@gmail.com | Test1111# | random     | 400            | Company not found. |