...
Feature: API_Dashboard POST /api/company
    Background: Send POST /login request to login before each test
        Given user sends a POST login request to get valid cookie with role
            ...
            | admin | testcreatecompany@gmail.com | Test1111# |
    ...
    Scenario Outline: <TC_ID> - Verify user <email> could call this API to create company with type <companyType> when input all data valid
        ...
        Examples:
            ...
            | TC_CCP001 | testcreatecompany@gmail.com | random      | ASC         | random       | random   | random        | currentDate     | random        | 201            | Created            | hard       |
    ...
    Scenario Outline: <TC_ID> - Verify user <email> could call this API to create company with type <companyType> when input all data valid
        ...
        Examples:
            ...
            | TC_CCP002 | testcreatecompany@gmail.com | random      | CSV         | random       | random   | random        | 201            | Created            | hard       |
            | TC_CCP003 | testcreatecompany@gmail.com | random      | QBO         | random       | random   | random        | 201            | Created            | hard       |
            | TC_CCP004 | testcreatecompany@gmail.com | random      | QBFS        | random       | random   | random        | 201            | Created            | hard       |
    ...
    Scenario Outline: <TC_ID> - Verify error when user sends this API with <cookie> cookie
        ...
        Examples:
            ...
            | TC_CCP005_1 | testcreatecompany@gmail.com | random      | CSV         | random       | random   | random        | empty   | 401            | Unauthorized       |
            | TC_CCP005_2 | testcreatecompany@gmail.com | random      | CSV         | random       | random   | random        | invalid | 401            | Unauthorized       |
    ...
    Scenario Outline: <TC_ID> - Verify error company already exists
        ...
        Examples:
            ...
            | TC_CCP006 | testcreatecompany@gmail.com | random      | CSV         | random       | random   | random        | 400            | Company name (or very similar) already exists. |