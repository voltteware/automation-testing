...
Feature: API_Admin PUT api/company/<companyKey>
  ...
  @TC_CCI001
  Scenario Outline: TC_CCI001 - Verify admin could call this API to change information of a company
    Given User sets GET api endpoint to get companies with type "<companyType>"
