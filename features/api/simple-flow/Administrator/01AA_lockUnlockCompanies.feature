...
Feature: API_Admin
    Background: Send GET /realm request to get all company keys of current logged in user before each test
        Given user sends a POST login request to get valid cookie with role
            ...
            | admin | testautolockunlock@gmail.com | Test1111# |
    ...
    Scenario Outline: <TC_ID> - Verify admin can lock by running forecast and unlock company <companyType>
        ...
        Examples:
            ...
            | TC_LU001 | admin | testautolockunlock@gmail.com | Test1111# | CSV         | 200            | OK                 |
            | TC_LU002 | admin | testautolockunlock@gmail.com | Test1111# | ASC         | 200            | OK                 |
            | TC_LU003 | admin | testautolockunlock@gmail.com | Test1111# | QBFS        | 200            | OK                 |
    
    # Comment this scenario because we just unlock company on UI, and still run sync on background
    ...
    #     Examples:
    #         | TC_ID    | role  | email                        | password  | companyType | expectedStatus | expectedStatusText |
    #         | TC_LU004 | admin | testautolockunlock@gmail.com | Test1111# | ASC         | 200            | OK                 |