...
Feature: API_Admin
    ...
    Scenario Outline: <TC_ID> - Verify admin can lock by running forecast and unlock company
        ...
        And The status text is "<expectedStatusText>"
        And User sets GET api endpoint to get list locked companies
        When User sends a GET request to get list locked companies
        ...
        Examples:
            ...
            | TC_LU001 | admin | testautoforecast@gmail.com | Test1111# | CSV         | 200            | OK                 |
            | TC_LU002 | admin | testautoforecast@gmail.com | Test1111# | ASC         | 200            | OK                 |
            | TC_LU003 | admin | testautoforecast@gmail.com | Test1111# | QBFS        | 200            | OK                 |
    ...
    Scenario Outline: <TC_ID> - Verify admin can lock by running sync and unlock company
        ...
        Examples:
            | TC_ID    | role  | email                      | password  | companyType | expectedStatus | expectedStatusText |
            | TC_LU004 | admin | testautoforecast@gmail.com | Test1111# | ASC         | 200            | OK                 |