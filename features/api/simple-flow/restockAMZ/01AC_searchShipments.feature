...
Feature: API_Regression User can search shipments
    ...
    @TC_ASC_SS001 @smoke-test-api
    Scenario Outline: <TC_ID> - Verify user <email> could call APIs to search shipments - Pending
        ...
        # Check search shipments works properly or not
        And User checks results in the search shipments api
        And User checks the new created shipment: <shipmentStatus>
        And User checks status code and status text of api
            | expectedStatus   | expectedStatusText   |
            | <expectedStatus> | <expectedStatusText> |
        And User checks API contract of get list shipments api
        # Delete shipments to prevent junk data
    ...
    Scenario Outline: <TC_ID> - Verify user <email> could call APIs could call APIs to search shipments - Working
        ...
        # Delete above shipment to preven junk data
