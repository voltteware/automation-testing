...
const myTagRule = atMostOnePicklePerTag(['@api-createBom', '@api-createItem', '@api-createSupplier', '@api-createSupply', '@api-change-password', '@api-overrideValue', '@api-editItemHistory', '@api-get-item-summary', '@api-purchasing-custom', '@api-purchasing-mySuggested', '@restock-calculation', '@api-lock-unlock','@check-update-item-level','@run-forecast']);
